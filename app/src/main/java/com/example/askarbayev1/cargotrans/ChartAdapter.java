...
class ChartAdpater extends BaseAdapter {
    Database db;
    List<Order> orders;
    private Context context;
    private LayoutInflater inflater;
    private int truck_user_id;
    ChartAdpater(Context context, List<Order> orders, int truck_user_id){
        this.orders = orders;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        if (view == null) {
            view = inflater.inflate(R.layout.char_orders_list, parent, false);
        }
